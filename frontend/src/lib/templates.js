 ...
 * Helps authors scaffold rich, multi-page technical deep dives in 1 click.
 */
...
export const NOTE_TEMPLATES = [
  {
    ...
    tagline: 'Multi-page architectural analysis with system diagrams, code, and trade-offs.',
