      ...
      <header className="sticky top-0 z-50 w-full border-b border-[var(--line)] bg-[var(--surface)]/95 backdrop-blur-md transition-colors duration-[var(--dur)] shadow-[var(--shadow-xs)]">
        <div className="max-w-[var(--maxw)] mx-auto px-4 sm:px-6 h-[var(--header-h)] flex items-center justify-between gap-2.5 sm:gap-4">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            {isAuthenticated && (
              <nav className="hidden md:flex items-center gap-1 ml-1 pl-3 border-l border-[var(--line)]">
          ...
          <div className="flex-1 max-w-xs md:max-w-sm hidden sm:flex items-center justify-center">
            <button
              onClick={handleSearchTrigger}
              className="w-full flex items-center justify-between px-3.5 py-1.75 rounded-[var(--radius-lg)] bg-[var(--surface-2)] hover:bg-[var(--surface)] border border-[var(--line)] hover:border-[var(--accent)] text-[var(--muted)] hover:text-[var(--ink)] transition-all cursor-pointer group shadow-xs active:scale-[0.99]"
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <button
              onClick={handleSearchTrigger}
              className="sm:hidden w-8.5 h-8.5 rounded-[var(--radius-md)] border border-[var(--line)] bg-[var(--surface-2)] flex items-center justify-center text-[var(--ink-2)] hover:text-[var(--ink)] hover:border-[var(--accent)] transition-all cursor-pointer"
              title="Search notes"
            >
              <Search size={15} />
            </button>
            ...
            <button
              ...
              className="sm:hidden p-2 rounded-[var(--radius-md)] text-[var(--ink)] hover:text-[var(--accent)] hover:bg-[var(--surface-2)] transition-all cursor-pointer border border-[var(--line)]"
              title="Toggle Menu"
            >
